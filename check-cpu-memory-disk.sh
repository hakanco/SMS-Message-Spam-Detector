...
# the code is taken from https://fedingo.com/shell-script-to-get-cpu-and-memory-utilization/#:~:text=Shell%20script%20to%20get%20CPU%20and%20memory%20utilization,Test%20shell%20script%205%20Create%20Cron%20Job.%20
